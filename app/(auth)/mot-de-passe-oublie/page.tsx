...
export default function MotDePasseOubliePage() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-6 py-16">
      <h1 className="font-display text-3xl text-noir">Mot de passe oublié</h1>
      <p className="mt-2 text-sm text-noir/60">
        Entrez votre email, nous vous enverrons un lien pour réinitialiser votre mot de passe.
      </p>

      {sent ? (
        <p className="mt-8 text-sm text-noir/80">
      ...
      <p className="mt-6 text-center text-sm text-noir/60">
        <Link href="/login" className="text-or-dark underline">Retour à la connexion</Link>
      </p>
    </div>
  );
}
